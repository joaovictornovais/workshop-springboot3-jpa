package com.joao.course.config;
...
import com.joao.course.entities.Payment;
import com.joao.course.entities.Product;
import com.joao.course.entities.User;
import com.joao.course.entities.enums.OrderStatus;
import com.joao.course.repositories.CategoryRepository;
import com.joao.course.repositories.OrderItemRepository;
...
public class TestConfig implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Order o1 = new Order(null, Instant.parse("2019-06-20T19:53:02Z"), OrderStatus.PAID, u1);
		Order o2 = new Order(null, Instant.parse("2019-07-21T03:42:02Z"), OrderStatus.WAITING_PAYMENT, u2);
		...
		Payment pay1 = new Payment(null, Instant.parse("2019-06-20T21:53:02Z"), o1);
		o1.setPayment(pay1);
